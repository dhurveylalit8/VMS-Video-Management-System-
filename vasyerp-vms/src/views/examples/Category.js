            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="input-group mb-3">
                  ...
                  <input type="text" className="form-control ps-2" placeholder="Enter category name" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"/>
                </div>

              </div>
              <div className="modal-footer">
                {/* <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Close</button> */}
                <button type="button" onClick={() => setNoOfRows(noOfRows + 1)} className="btn btn-secondary">Submit</button>
              </div>
            </div>
          </div>
        </div>
        <div className="addCategory d-flex align-items-center justify-content-center text-light" type="button"  data-bs-toggle="modal" data-bs-target="#staticBackdrop" style={{zIndex:"999",position:"fixed", bottom:"50px", right:"50px", borderRadius:"50%", backgroundColor:"#11cdef", padding:"1rem",width:"50px", height:"50px"}}>
